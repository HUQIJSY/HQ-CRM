...
class Customer(models.Model):
    ...
    # 展示班级,客户-班级多对多关系,得到的是管理对象,调用str方法,把class中的__str__中内容获取到
    ...
    def show_status(self):
        ...
        # 第一个参数从数据库中获取状态码给与相应颜色,第二参数获取choices状态
...
class ConsultRecord(models.Model):
    ...
    # 跟进状态是choices,定义一个方法获得get_status_display
    def show_status(self):
        '''
        (('A', '近期无报名计划'), ('B', '1个月内报名'), ('C', '2周内报名'), ('D', '1周内报名'),
          ('E', '定金'), ('F', '到班'), ('G', '全款'), ('H', '无效'),)
        :return:
        '''
